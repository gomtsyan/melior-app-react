...
import { APIBaseURI, indexItemsLocationEndpoint } from "../../../constants";
import PropTypes from 'prop-types';

const getData = async () => {
    try {
        const response = await fetch(APIBaseURI+indexItemsLocationEndpoint)
...
const IndexedLocationColumnChart = () => {
...
IndexedLocationColumnChart.propTypes = {
    filteredData: PropTypes.array,
}
export default IndexedLocationColumnChart;
